	...
	<div>
		<el-form ref="form" label-position="right" label-width="80px">
			...
			<el-form-item label="总库存">
				<el-input :value="stock" @input="vModel('stock', $event)" type="number" placeholder="" class="w-25">
			...
			<el-form-item label="库存预警">
				<el-input :value="min_stock" @input="vModel('min_stock', $event)" type="number" placeholder="" class="w-25">
					<template slot="append">
						件
					</template>
				</el-input>
