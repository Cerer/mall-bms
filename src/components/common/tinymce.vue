<template>
	<div class="tinymce-box"><editor v-model="myValue" :init="init" :disabled="disabled" @click="onClick"></editor></div>
</template>
...
import 'tinymce/models/dom/model'; // 解决了model.js 报错Unexpected token '<'
