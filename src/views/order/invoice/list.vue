...
<template>
	<div class="bg-white px-3" style="margin: -20px;margin-top: -1rem;margin-bottom: 0 !important;">
		...
		<el-table :data="tableData" class="mt-3" border @selection-change="handleSelectionChange">
			...
			<el-table-column label="开票金额" prop="price" align="center"></el-table-column>
			<el-table-column label="抬头" prop="price" align="center"></el-table-column>
			<el-table-column label="发票内容" prop="content" align="center"></el-table-column>
			<el-table-column label="纳税人识别号" prop="code" align="center"></el-table-column>
